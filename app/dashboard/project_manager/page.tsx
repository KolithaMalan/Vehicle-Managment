...
import { 
  MapPin, Clock, Check, X, AlertCircle, User, Map, History, Eye, 
  ArrowLeftRight, ArrowRight, Gauge, CheckCircle, FileText // ✅ ADDED CheckCircle and FileText
} from 'lucide-react';
...
<div className="grid md:grid-cols-4 gap-6">
  ...
  <RoleCard
    ...
    value={processedRides.filter(ride => 
  ...
  <RoleCard
    ...
    value={rides.filter(ride => ride.distanceKm >= 25).length}
    icon={MapPin}
    role="project_manager"
    subtitle="≥25km rides"
  />
