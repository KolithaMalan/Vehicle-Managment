...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const getNavigationItems = () => {
    ...
    const roleSpecificItems = {
      ...
      driver: [
        ...
        { 
          name: 'My Daily Rides', 
          href: '/dashboard/driver/daily-rides', 
          icon: Car,
      ...
      project_manager: [
        { 
          name: 'Approvals', 
          href: '/dashboard/project_manager', 
          icon: UserCheck,
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center transition-colors duration-300">
        <Card className="w-full max-w-sm shadow-xl border-0 dark:bg-gray-800">
          <CardContent className="p-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <div className="h-3 bg-gray-100 dark:bg-gray-600 rounded-full w-3/4 mx-auto animate-pulse"></div>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">Loading your dashboard...</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-80 bg-white dark:bg-gray-800 backdrop-blur-xl shadow-2xl border-r-2 border-blue-500 dark:border-blue-700 transform transition-all duration-500 ease-out ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
      }`}>
        
        {/* Sidebar Header */}
        <div className="relative h-20 px-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-blue-500 dark:bg-blue-600">
        ...
        <div className="flex flex-col h-[calc(100vh-5rem)]">
          ...
          <div className="p-6 border-b bg-blue-200/50 dark:bg-blue-900/20 dark:border-gray-700">
          ...
          <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            <div className="mb-4">
              <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider px-3">Navigation</p>
            </div>
                  ...
                  <Link href={item.href} onClick={() => setSidebarOpen(false)}>
                    <button
                      className={`w-full flex items-center justify-between px-4 py-4 text-sm font-medium rounded-2xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg ${
                        isActive
                          ? `${item.bgColor} ${item.textColor} scale-[1.02] border border-blue-200 dark:border-blue-700`
          ...
          {/* Quick Actions */}
          <div className="px-4 py-4 border-t border-gray-200/50 dark:border-gray-700">
            <div className="mb-3">
              <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider px-3">Quick Actions</p>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <button className="flex flex-col items-center p-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-xl transition-all duration-200 group">
                <Bell className="w-5 h-5 text-gray-600 dark:text-gray-300 mb-1 group-hover:scale-110 transition-transform duration-200" />
                <span className="text-xs text-gray-600 dark:text-gray-300 font-medium">Alerts</span>
              </button>
              <button className="flex flex-col items-center p-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-xl transition-all duration-200 group">
                <Settings className="w-5 h-5 text-gray-600 dark:text-gray-300 mb-1 group-hover:scale-110 transition-transform duration-200" />
                <span className="text-xs text-gray-600 dark:text-gray-300 font-medium">Settings</span>
              </button>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-gray-200/50 dark:border-gray-700">
            <Button 
              variant="outline" 
              onClick={logout}
              className="w-full group bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 border-red-200 dark:border-red-800 hover:from-red-100 hover:to-pink-100 dark:hover:from-red-900/30 dark:hover:to-pink-900/30 hover:border-red-300 dark:hover:border-red-700 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-all duration-300 transform hover:scale-[1.02] h-12 rounded-xl font-medium"
            >
      ...
      <div className="lg:pl-80 min-h-screen flex flex-col">
        {/* Enhanced Top bar */}
        <header className="sticky top-0 z-30 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl shadow-sm border-b border-gray-200/50 dark:border-gray-700/50 flex-shrink-0 transition-colors duration-300">
          <div className="flex items-center justify-between h-16 px-6">
            <div className="flex items-center gap-4">
              <button
                onClick={() => setSidebarOpen(true)}
                className="lg:hidden p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 group"
              >
                <Menu className="w-6 h-6 text-gray-700 dark:text-gray-300 group-hover:scale-110 transition-transform duration-200" />
              </button>
              ...
              <div className="hidden lg:block">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">Have a productive day!</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Status indicator */}
              <div className="hidden sm:flex items-center space-x-2 px-3 py-1.5 bg-green-50 dark:bg-green-900/20 rounded-full border border-green-200 dark:border-green-800">
              ...
              <button className="relative p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 group">
                ...
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 border-2 border-white dark:border-gray-800 rounded-full animate-bounce"></div>
              </button>
            </div>
          </div>
        </header>
